...
public class TravelAgencyCtr {
	...
	public int updateTravelAgency(int travelAgencyId, String name, double discount, String address, String phoneNo, String email){
		IFDBTravelAgency dbTravelAgency=new DBTravelAgency();
		TravelAgency travelAgency=new TravelAgency(travelAgencyId, name, discount, address, phoneNo, email);
		return dbTravelAgency.updateTravelAgency(travelAgency);
	}
	
	public int insertTravelAgency(String name, double discount, String address, String phoneNo, String email){
		TravelAgency travelAgency=new TravelAgency(name, discount, address, phoneNo, email);	
		try{
