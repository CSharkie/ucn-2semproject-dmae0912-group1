...
public interface IFDBSportFacilityBookingLine {
	...
	public LinkedList<SportFacilityBookingLine> getAllSportFacilityBookingLines(int sportFacilityBookingId, boolean retrieveAssociation);
    //get one SportFacilityBookingLine by ID
	public SportFacilityBookingLine searchSportFacilityBookingLineById(int sportFacilityBookingLineId, boolean retrieveAssociation);
	//insert a new SportFacilityBookingLine
	public int insertSportFacilityBookingLine(SportFacilityBookingLine sportFacilityBookingLine) throws Exception;
