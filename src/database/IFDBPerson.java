...
public interface IFDBPerson {
	//getAllPersons
	public LinkedList<Person> getAllPersons(boolean retrieveAssociation);
	...
	public LinkedList<Person> searchPersonsByName(String name, boolean retrieveAssociation);
}
